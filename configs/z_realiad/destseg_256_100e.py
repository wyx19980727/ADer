...
class cfg(cfg_common, cfg_dataset_default, cfg_model_destseg):
	...
	def __init__(self):
		...
		self.data.anomaly_source_path = '/home/albus/DataSets/dtd/images/'
		...
		# ==> optimizer
		self.optim.de_st = Namespace()
		self.optim.de_st.kwargs = dict(name='adamw', betas=(0.9, 0.999), eps=1e-8, weight_decay=self.weight_decay, amsgrad=False)
