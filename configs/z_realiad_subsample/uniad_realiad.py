...
class cfg(cfg_common, cfg_dataset_default, cfg_model_uniad):
	...
	def __init__(self):
		...
		# self.model.kwargs = dict(pretrained=True, checkpoint_path='runs/UniADTrainer_configs_uniad_uniad_realiad_20241030-134150/net.pth', strict=True, model_backbone=self.model_backbone,
