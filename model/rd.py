...
class RD(nn.Module):
	...
	def forward(self, imgs):
		...
		# merge_embedding = self.mff_oce(feats_t)
		# feats_contrast = merge_embedding
		# feats_contrast = self.contrastive_head(feats_contrast.view(merge_embedding.size(0), -1))
		# #import ipdb; ipdb.set_trace()
