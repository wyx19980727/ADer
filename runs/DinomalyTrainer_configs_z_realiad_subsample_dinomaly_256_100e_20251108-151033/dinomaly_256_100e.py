...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
    ...
    def __init__(self):
        ...
        self.model.kwargs = dict(
                ...
                # pretrained=True, checkpoint_path='runs/Dinomaly_base_loosecosloss_size256_dinov3_officialloadhub_freeze_decodernorope_drop0.4_25811 (448×448 center crop 384 × 384)_train/net.pth', strict=True,
