...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
    ...
    def __init__(self):
        ...
        self.data.train_transforms = [
            ...
            dict(type='CenterCrop', size=(self.crop_size, self.crop_size)),
            dict(type='ToTensor'),
        ...
        self.model.kwargs = dict(
                ...
                #pretrained=True, checkpoint_path='runs/DinomalyTrainer_configs_z_realiad_subsample_dinomaly_256_100e_20251108-205143/net.pth', strict=True,
                ...
                fuse_layer_decoder = [[0], [3], [6], [9]],
                # # fuse_layer_encoder = [[0, 1, 2, 3]], 
                # # fuse_layer_decoder = [[0, 1, 2, 3]],
                #  target_layers = [4, 5, 6, 7, 8, 9, 10, 11], 
                #  fuse_layer_encoder = [[0, 1, 2, 3], [4, 5, 6, 7]], 
                #  fuse_layer_decoder = [[0, 1, 2, 3], [4, 5, 6, 7]],                 
                num_decoder_blocks=12
                )				   
        #self.model.kwargs = dict(pretrained=True, checkpoint_path='runs/_subsample_ablation/_dinomaly/Dinomaly_small_loosecosloss_train/net.pth', strict=True)
        ...
        self.loss.loss_terms = [
            ...
            # dict(type='SupervisedContrastiveLoss', name='glb', lam=1.0, temperature=0.05),
            dict(type='LocalContrastiveLoss', name='lcl', lam=1.0, temperature=0.05),
        ]
        ...
        self.logging.log_terms_train = [
            ...
            dict(name='lcl', suffixes=[''], fmt=':>5.3f', add_name='avg'),
        ]
