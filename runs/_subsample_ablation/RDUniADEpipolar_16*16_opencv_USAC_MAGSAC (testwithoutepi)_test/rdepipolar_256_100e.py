...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
	...
	def __init__(self):
		...
		self.model.kwargs = dict(pretrained=True, checkpoint_path='runs/_subsample_ablation/RDUniADEpipolar_16*16_opencv_USAC_MAGSAC (testwithoutepi)_train/net.pth', strict=True, model_t=self.model_t,
								 model_s=self.model_s)
