...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
	...
	def __init__(self):
		...
		self.model.kwargs = dict(pretrained=True, checkpoint_path='runs/DinomalyTrainer_configs_z_realiad_subsample_dinomaly_256_100e_20250923-174115/net.pth', strict=True)
