...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
	...
	def __init__(self):
		...
		# self.model.kwargs = dict(pretrained=True, checkpoint_path='runs/_full_ablation/RDUniADEpipolar_8*8_matchanything_FM_RANSAC (none)/net.pth', strict=True, model_t=self.model_t,
		# 						 model_s=self.model_s)
