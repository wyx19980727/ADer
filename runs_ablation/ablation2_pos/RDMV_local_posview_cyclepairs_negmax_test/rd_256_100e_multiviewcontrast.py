...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
	...
	def __init__(self):
		...
		self.model.kwargs = dict(pretrained=True, checkpoint_path='runs_compare/ablation2_pos/RDMV_local_posview_cyclepairs_negmax/net.pth', strict=True, model_t=self.model_t,
								 model_s=self.model_s)
