...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
	...
	def __init__(self):
		...
		self.model.name = 'rdmv'
		self.model.kwargs = dict(pretrained=False, checkpoint_path='', strict=True, model_t=self.model_t,
								 model_s=self.model_s)
  
		# self.model.kwargs = dict(pretrained=True, checkpoint_path='runs_compare/ablation1_overall/RDMVTrainer_configs_z_realiad_rd_256_100e_multiviewcontrast_20250407-101333/net.pth', strict=True, model_t=self.model_t,
		# 						 model_s=self.model_s)
