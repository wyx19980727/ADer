...
class cfg(cfg_common, cfg_dataset_default, cfg_model_simplenet):
	...
	def __init__(self):
		...
		self.model.kwargs = dict(pretrained=True, checkpoint_path='runs_compare/simplenet_train/net.pth', strict=True, model_backbone=self.model_backbone, layers_to_extract_from=self.layers_to_extract_from, input_size=self.input_size)
