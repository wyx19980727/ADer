...
class DinomalyTrainer(BaseTrainer):
    ...
    def forward(self):
        self.en, self.de, self.en_proj, self.glb_feats = self.net(self.imgs, self.img_path)
    ...
    def optimize_parameters(self):
        ...
        with self.amp_autocast():
            ...
            loss_lcl = self.loss_terms['lcl'](self.en, self.en_proj, self.de, self.labels, self.img_path)
            loss = loss_cos + loss_lcl
